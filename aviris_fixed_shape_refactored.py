...
Usage:
    # Run both stages
    python aviris_fixed_shape_refactored.py --use_fsf --model awan --tile_size 100 --epochs 100 \
    ...
    python aviris_fixed_shape_refactored.py --use_fsf --model awan --tile_size 100 \
...
def visualize_shape(shape, save_path):
    ...
    # Use plot_shape_with_c4 from base file if available, otherwise use local implementation
