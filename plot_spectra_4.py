...
def main():
    ...
    parser.add_argument("--output_folder", type=str, default="spectra_plots/11x1",
    ...
    for i in range(spectra.shape[0]):
        plot_single_spectrum(x, spectra[i, :], index=i+1, output_folder=args.output_folder+"-"+str(args.idx))
