...
--
-- Usage example:
--   ../build/S4 -a "partial_csv=partial_crys_data/partial_crys_C0.0.csv shape_str=0.1,0.2;0.2,0.1 out_csv=out_c0.0.csv" metasurface_check.lua
--   ../build/S4 -a "partial_csv=partial_crys_data/partial_crys_C0.0.csv shape_str=1.0710926432360077,0.61887392167816768;0.38112607832183237,1.0710926432360077;-0.071092643236007724,0.38112607832183243;0.61887392167816757,-0.071092643236007724 out_csv=out_c0.0.csv" metasurface_check.lua
--
-- This script:
