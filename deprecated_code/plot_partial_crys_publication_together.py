...
def main():
    ...
    # Loop over c values and plot on both axes
    ...
    # We get the handles and labels from one axis since they are identical.
    handles, labels = ax1.get_legend_handles_labels()
    # Position the legend at the top center of the figure with one row per legend entry
    fig.legend(handles, labels, loc='upper center', ncol=len(c_values), fontsize=14, frameon=False)
