...
def plot_single_spectrum(x, y, index, output_folder="spectra_plots"):
    ...
    Removes axes and texts, and saves the figure to the output folder.
    """
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot each of 11 spectra as an individual 11x2 inch figure with no texts or axes."
    )
