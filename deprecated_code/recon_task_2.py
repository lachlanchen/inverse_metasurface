...
def optimize_shape_for_target_spectrum():
    ...
    plot_shape_and_spectrum(gt_shape, gt_spectrum, "Ground Truth", "gt_shape_spectrum.png")
    ...
    plot_shape_and_spectrum(initial_shape, initial_spectrum, "Initial Shape", "initial_shape_spectrum.png")
        ...
        if (i+1) % 20 == 0 or i == 0:
            ...
            if (i+1) % 50 == 0:
                plot_shape_and_spectrum(
                    ...
                    f"optimized_shape_iter_{i+1}.png"
                )
    ...
    print("\nGround truth raw parameters:")
    print(gt_raw_params.cpu().numpy())
    print("Ground truth raw shift:", gt_raw_shift.item())
    ...
    print("Initial raw shift:", 0.7)
    
    print("\nFinal optimization parameters:")
    print(opt_raw_params.detach().cpu().numpy())
    print("Final raw shift:", opt_raw_shift.item())
