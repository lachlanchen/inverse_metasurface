...
def load_aviris_swir_data(swir_base_path="AVIRIS_SWIR_INTP", tile_size=100, cache_file=None, use_cache=False):
    """
...
def train_with_noise_level(model_path, output_dir, noise_level, batch_size=10, num_epochs=500, 
    ...
    data = load_aviris_swir_data(swir_base_path="AVIRIS_SWIR_INTP", tile_size=100, cache_file=cache_file, use_cache=use_cache)
    data = data.to(device)
