...
def main():
    ...
    # Load the trained models (adjust paths as necessary)
    ...
    if pred_full is not None:
        ...
        for c in c_values:
            ...
            if s4_csv is not None:
                ...
                print(f"[ERROR] S4 failed for c = {c:.1f}")
    ...
    # Create an output folder for the figure
    out_folder = "SpecShapeS4_Evaluator_Plots"
    ...
    plt.tight_layout()
    outpng = os.path.join(out_folder, "check_npz_with_spec2shape2spec.png")
