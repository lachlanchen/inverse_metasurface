...
def plot_sample(axes, col, sample_data, s4_spectra_list):
    ...
    ax_gt_spec.set_title("GT Transmittance")
    ax_gt_spec.set_xlabel("Wavelength index")
    ax_gt_spec.set_ylabel("Transmittance")
    ax_gt_spec.legend(fontsize=8)
    
    # Row 3: Network output spectrum (from shape2spec) - TRANSMITTANCE
...
def main():
    ...
    for g_idx, group in enumerate(groups):
        ...
        for col in range(4):
            ...
            plot_sample(axes, col, sample_data, s4_spectra_list)
